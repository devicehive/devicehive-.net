...
namespace DeviceHive.Client
{
    ...
    {
        /// <summary>
        /// Gets a list of networks for the specified filter criteria.
        /// </summary>
        /// <param name="filter">Network filter criteria.</param>
        /// <returns>A list of <see cref="Network"/> objects that match specified filter criteria.</returns>
        List<Network> GetNetworks(NetworkFilter filter = null);
        ...
        List<Device> GetDevices(DeviceFilter filter = null);
        ...
        List<Notification> GetNotifications(Guid deviceId, NotificationFilter filter);
        ...
        /// <param name="token">Cancellation token used to cancel the polling operation.</param>
        /// <returns>A list of <see cref="Notification"/> objects.</returns>
        List<DeviceNotification> PollNotifications(Guid[] deviceIds, DateTime? timestamp, CancellationToken token);
        ...
        List<Command> GetCommands(Guid deviceId, CommandFilter filter);
